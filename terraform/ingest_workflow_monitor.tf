locals {
  ingest_workflow_monitor_key_name    = "ingest-workflow-monitor"
  ingest_workflow_monitor_lambda_name = "${local.environment}-dr2-${local.ingest_workflow_monitor_key_name}"
}
