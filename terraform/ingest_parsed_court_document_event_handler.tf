...
module "dr2_ingest_parsed_court_document_event_handler_lambda" {
  ...
  vpc_config = {
    ...
    security_group_ids = [module.outbound_https_access_only.security_group_id, module.outbound_https_access_for_s3.security_group_id, module.https_to_vpc_endpoints_security_group.security_group_id]
  }
  tags = {
