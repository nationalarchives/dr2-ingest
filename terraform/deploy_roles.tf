  ...
  policy_string = templatefile("${path.module}/templates/iam_policy/deploy_lambda_policy.json.tpl", {
    lambda_arns = jsonencode(flatten(
      [
        ...
        module.cc_restore_preingest.aggregator_lambda.arn,
        module.cc_restore_preingest.package_builder_lambda.arn,
        module.cc_restore_preingest.importer_lambda.arn,
        module.court_document_preingest.aggregator_lambda.arn,
        module.court_document_preingest.package_builder_lambda.arn,
        module.court_document_preingest.importer_lambda.arn,
