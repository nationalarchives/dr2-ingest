...
module "dr2_ingest_mapper_lambda" {
  ...
  vpc_config = {
    ...
    security_group_ids = [module.outbound_discovery_https_access.security_group_id, module.outbound_https_access_for_s3.security_group_id, module.outbound_https_access_for_dynamo_db.security_group_id]
  }
  tags = {
...
module "discovery_inbound_https" {
  ...
  rules = {
    ingress = [{
      ...
      security_group_id = module.outbound_discovery_https_access.security_group_id
    }]
  }
}
