...
locals {
  ...
  aggregator_secondary_grouping_window_seconds = var.aggregator_secondary_grouping_window_seconds                                           # Additional time we wait before starting preingest to allow multiple invocations to form a single group, this is added to the aggregator_lambda_timeout_seconds when we start a group.
