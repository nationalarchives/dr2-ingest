package scala.uk.gov.nationalarchives.ingestparsedcourtdocumenteventhandler
...
import uk.gov.nationalarchives.ingestvalidategenericingestinputs.FileProcessor.*
import uk.gov.nationalarchives.ingestvalidategenericingestinputs.SeriesMapper
import uk.gov.nationalarchives.ingestvalidategenericingestinputs.SeriesMapper.{Court, Output}
...
import scala.collection.immutable.{List, ListMap, Set}
import scala.io.circe.generic.auto.*
import scala.io.circe.parser.decode
import scala.io.circe.syntax.*
import scala.io.circe.{Decoder, DecodingFailure, Printer}
