...
object Dependencies {
  ...
  lazy val commonsCodec = "commons-codec" % "commons-codec" % "1.22.0"
  ...
  lazy val jsonSchemaValidator = "com.networknt" % "json-schema-validator" % "3.0.5"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.174"
