...
object Dependencies {
  ...
  lazy val daAwsClientsVersion = "0.1.149"
  ...
  lazy val awsDynamo = "software.amazon.awssdk" % "dynamodb" % "2.42.6"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.163"
