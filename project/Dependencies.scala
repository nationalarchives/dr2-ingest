...
object Dependencies {
  ...
  lazy val daAwsClientsVersion = "0.1.128"
  ...
  lazy val awsDynamo = "software.amazon.awssdk" % "dynamodb" % "2.32.31"
  ...
  lazy val preservicaClient = "uk.gov.nationalarchives" %% "preservica-client-fs2" % "0.0.144"
